...
export const companiesData: Company[] = [
  {
    ...
    location: "Mali",
    mission: "Deploying sovereign energy systems and microgrids to bypass centralized grids in rural Mali.",
  ...
  },
  {
    ...
    location: "Nairobi",
    mission: "Engineering climate-resilient crops and vertical protein to ensure food sovereignty in East Africa.",
    technologies: ["CRISPR", "Vertical Farming", "Genomics"],
    funding: "$8M Series A",
    teamSize: "50-200",
  },
  {
    id: "sovereign-data-net",
    field: "Intelligence",
    name: "SovereignData Net",
    focus: "Decentralized Ident",
    location: "Senegal",
    mission: "Establishing sovereign AI and decentralized identity networks governed by local communities.",
