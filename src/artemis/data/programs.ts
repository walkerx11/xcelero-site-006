...
export const programsData: ProgramDetail[] = [
  ...
  },
  {
    ...
    ideas: [
      { partner: "Studio Lead", title: "CivicID v2", desc: "Next-gen zero-knowledge identity protocol for sovereign governance. Enables privacy-preserving citizen verification at national scale.", partnerImage: "https://i.pravatar.cc/100?img=15" },
  ...
  },
  {
    ...
    ideas: [
      ...
      { partner: "IP Strategist", title: "GenomeVault", desc: "Sovereign genomic data infrastructure for African populations. Privacy-preserving federated learning for drug discovery without data export.", partnerImage: "https://i.pravatar.cc/100?img=30" }
    ],
    testimonial: {
