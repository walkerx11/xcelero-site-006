...
export const routeLegs: RouteLeg[] = [
  ...
  },
  {
    ...
    signatureDeals: [
      ...
      {
        name: "Climate Data Sovereignty Lab",
        duration: "5 days",
      ...
      },
      {
        ...
        duration: "6 days",
        focus: "Self-sovereign identity for conflict-displaced populations",
  ...
  },
  {
    ...
    culturalWeaving: {
      ...
      heritageWalk: "Fort Jesus (Mombasa) → Stone Town (Zanzibar). From the Portuguese fortress that changed hands nine times, to the Omani palace city where slave and spice markets operated side by side. Architecture as evidence of contested sovereignty.",
...
export const arcPricing: ArcPricing[] = [
  ...
  },
  {
    ...
    inclusions: ["Desert transit logistics", "Mesh-network deployment kit", "Climate data sovereignty tools", "Humanitarian corridor access", "Pastoral community immersion", "Heritage walk program", "Emergency protocol training"],
  },
  {
    legId: "east-african",
    pricePerPerson: 4500,
  ...
  },
  {
    ...
    durationWeeks: 10,
    scholarshipsPerDeparture: 2,
    inclusions: ["Sovereign data routing lab", "Regulatory harmonization toolkit", "Diaspora investment network access", "Maritime logistics optimization", "Mediterranean port authority access", "Global gateway connections", "Compass ceremony program", "Year-end deal flow acceleration"],
  },
];
