...
function generateOrigin(venture: (typeof venturesData)[number]): string[] {
  ...
  const originTheses: Record<string, { facts: string; observation: string; proof: string; thesis: string }> = {
    ...
    "Data & Intelligence": {
      facts: "95% of AI is trained on English-language data. 2,000+ African languages have less than 0.1% of global training data. Government decisions in Africa are made with 18–24 month old data, contributing to $50 billion+ in misallocated public spending annually. Data sovereignty and AI capability are inseparable — you cannot outsource one without surrendering the other.",
      observation: "Sovereign intelligence infrastructure is the prerequisite for sovereign decision-making. The same data that African governments, hospitals, and farms generate daily is being processed by foreign AI systems and sold back at premium prices. The value chain is extractive by design: African data feeds foreign intelligence, which makes foreign decisions about African outcomes.",
      proof: "Federated learning architectures now allow AI models to be trained on data that never leaves its source country. Rwanda's national data platform processes health, agriculture, and infrastructure data locally while contributing to continental models. India's Aadhaar system demonstrated that sovereign digital infrastructure at billion-person scale is achievable.",
      thesis: "If data sovereignty and AI capability can be developed simultaneously — training models on local data for local decisions while contributing to collective intelligence — then sovereign intelligence that serves the people who generate it becomes not just desirable but structurally inevitable."
    },
    "Built Environments": {
    ...
    "Digital Finance": {
      facts: "1.7 billion adults are unbanked globally. Mobile money covers 400 million Africans but lacks multi-currency, cross-border rails. 57% of Africans remain unbanked. African sovereign bonds yield 8–15% yet are inaccessible to retail investors. Cross-border banking for African diaspora costs 7–10% in fees. $95 billion in annual diaspora remittances flows through extractive intermediaries.",
    ...
    "Space & Off-World Industrialization": {
      facts: "Africa has zero sovereign launch capability. The $1 trillion space economy by 2040 is entirely Western and Chinese. African nations spend $600 million annually on foreign satellite data. Only 30% of Africa has internet access; satellite internet costs $600/year — unaffordable for 80% of the population. 700 million Africans remain offline.",
      observation: "Orbital sovereignty is the next frontier of national independence. A continent of 54 nations can pool orbital ambition into a single sovereign capability. The cost of access to space has fallen 95% since 2010 — SpaceX rideshare launches at $1.1 million to orbit. The barrier is no longer physics; it is institutional coordination and capital allocation.",
      proof: "Rwanda launched its first satellite (RwandaSat-1) in 2019 for $1.5 million via rideshare. Kenya's 1KUNS-PF cubesat demonstrated Earth observation at under $500,000. The UAE built a sovereign space program from zero to Mars mission in 12 years. Small satellite constellations now provide sub-meter Earth observation at 1/100th the cost of legacy systems.",
      thesis: "If a continent of 54 nations can pool orbital ambition into a single sovereign capability — shared satellites, shared ground stations, shared data — then Africa's permanent seat at the table of the space economy becomes not aspirational but structurally inevitable."
    },
    "Quantum Computing": {
      ...
      thesis: "If quantum computing can be demystified, decentralized, and deployed as sovereign infrastructure — accessible to researchers and nations regardless of geography — then quantum advantage becomes a shared resource rather than a proprietary one, and the $120 trillion in digital assets at risk from quantum decryption gains a defense."
    },
    ...
    "Communication & Culture": {
      ...
      thesis: "If every African language can achieve real-time digital presence — translation, voice, text — and if the infrastructure cannot be shut down because it is decentralized, then a linguistically sovereign digital civilization becomes possible for the 2,000+ African languages currently excluded from the digital world."
    },
    "Consumer & e-Commerce": {
    ...
    "Rare Earth & Mineral Sovereignty": {
    ...
    "Governance & Network States": {
      facts: "Democratic participation in Africa averages 30–50% turnout. Corruption costs Africa $100+ billion annually. 100+ countries have SEZ frameworks but no sovereign governance OS. Citizens have no real-time visibility into government spending. African passport holders can visit only 30 countries visa-free.",
